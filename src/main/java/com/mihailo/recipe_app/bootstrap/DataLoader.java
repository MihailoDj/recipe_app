...
import com.mihailo.recipe_app.model.*;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public DataLoader(CategoryRepository categoryRepository, UnitOfMeasurementRepository unitOfMeasurementRepository, RecipeRepository recipeRepository) {
    ...
    public List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<UnitOfMeasurement> eachUomOptional =
                unitOfMeasurementRepository.findByUnitOfMeasurement("Each");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected Unit if measurement Not Found");
        }

        Optional<UnitOfMeasurement> tableSpoonUomOptional =
                unitOfMeasurementRepository.findByUnitOfMeasurement("Tablespoon");

        if(!tableSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected Unit if measurement Not Found");
        }

        Optional<UnitOfMeasurement> teaSpoonUomOptional =
                unitOfMeasurementRepository.findByUnitOfMeasurement("Teaspoon");

        if(!teaSpoonUomOptional.isPresent()){
            throw new RuntimeException("Expected Unit if measurement Not Found");
        }

        Optional<UnitOfMeasurement> dashUomOptional =
                unitOfMeasurementRepository.findByUnitOfMeasurement("Dash");

        if(!dashUomOptional.isPresent()){
            throw new RuntimeException("Expected Unit if measurement Not Found");
        }

        Optional<UnitOfMeasurement> pintUomOptional =
                unitOfMeasurementRepository.findByUnitOfMeasurement("Pint");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected Unit if measurement Not Found");
        }

        Optional<UnitOfMeasurement> cupsUomOptional =
                unitOfMeasurementRepository.findByUnitOfMeasurement("Cup");
        ...
        guacRecipe.getCategories().add(frenchCategory);
