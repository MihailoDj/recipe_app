...
public class IngredientServiceImpl implements IngredientService {
    ...
    public IngredientServiceImpl(IngredientToIngredientCommand ingredientToIngredientCommand, IngredientCommandToIngredient ingredientCommandToIngredient, RecipeRepository recipeRepository, UnitOfMeasurementRepository unitOfMeasurementRepository) {
    ...
    public IngredientCommand saveIngredientCommand(IngredientCommand command) {
        ...
        if(!recipeOptional.isPresent()){
            ...
            if(ingredientOptional.isPresent()){
                ...
                ingredientFound.setUnitOfMeasurement(unitOfMeasurementRepository
                        .findById(command.getUnitOfMeasurement().getId())
            ...
            if(!savedIngredientOptional.isPresent()){
                ...
                savedIngredientOptional = savedRecipe.getIngredients().stream()
                        ...
                        .filter(recipeIngredients -> recipeIngredients.getUnitOfMeasurement().getId().equals(command.getUnitOfMeasurement().getId()))
                        .findFirst();
            }
